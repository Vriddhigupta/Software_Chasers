...
public class EC_Grades extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_e_c__grades);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Upload3 upload = uploadList.get(position);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference(Constants3.DATABASE_PATH_UPLOADS);
        databaseReference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for(DataSnapshot postSnapshot :dataSnapshot.getChildren() ) {
                    Upload3 upload = postSnapshot.getValue(Upload3.class);
    ...
    private void uploadFile(Uri data){
        ...
        ref.putFile(data).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Upload3 upload = new Upload3(edit.getText().toString(),url.toString());
