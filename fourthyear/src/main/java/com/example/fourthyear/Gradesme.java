...
import com.example.fourthyear.ui.login.ConstantsME;
...
public class Gradesme extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gradesme);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference(ConstantsME.DATABASE_PATH_UPLOADS);
    ...
    private void uploadFile(Uri data){
        ...
        storageReference = firebaseStorage.getInstance().getReference();
        StorageReference ref = storageReference.child(ConstantsME.STORAGE_PATH_UPLOADS + System.currentTimeMillis() + ".pdf");
