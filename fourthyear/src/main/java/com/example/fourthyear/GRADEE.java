...
import com.example.fourthyear.ui.login.ConstantsEE;
...
public class GRADEE extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g_r_a_d_e_e);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference(ConstantsEE.DATABASE_PATH_UPLOADS);
    ...
    private void uploadFile(Uri data){
        ...
        storageReference = firebaseStorage.getInstance().getReference();
        StorageReference ref = storageReference.child(ConstantsEE.STORAGE_PATH_UPLOADS + System.currentTimeMillis() + ".pdf");
