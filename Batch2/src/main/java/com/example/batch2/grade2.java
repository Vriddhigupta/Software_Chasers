...
public class grade2 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewStatus = (TextView) findViewById(R.id.textViewStatus786);
        edit = (EditText) findViewById(R.id.edit);
        progressBar = (ProgressBar) findViewById(R.id.progressbar);
        findViewById(R.id.button411).setOnClickListener(this);
