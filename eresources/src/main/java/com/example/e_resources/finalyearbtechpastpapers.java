...
public  class finalyearbtechpastpapers extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_finalyearbtechpastpapers);
    ...
    private void viewAllFiles() {
        databaseReference = FirebaseDatabase.getInstance().getReference("uploads_8");
    ...
    private void uploadFile(Uri data){
        ...
        storageReference = firebaseStorage.getInstance().getReference();
        StorageReference ref = storageReference.child(Constant8.STORAGE_PATH_UPLOADS + System.currentTimeMillis() + ".pdf");
