...
public class GradeCs extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grade_cs);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference(ConstantsCs.DATABASE_PATH_UPLOADS);
    ...
    private void uploadFile(Uri data){
        ...
        storageReference = firebaseStorage.getInstance().getReference();
        StorageReference ref = storageReference.child(ConstantsCs.STORAGE_PATH_UPLOADS + System.currentTimeMillis() + ".pdf");
