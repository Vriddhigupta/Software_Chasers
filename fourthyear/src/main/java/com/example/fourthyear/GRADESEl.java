...
import com.example.fourthyear.ui.login.ConstantsEL;
...
public class GRADESEl extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g_r_a_d_e_s_el);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference(ConstantsEL.DATABASE_PATH_UPLOADS);
    ...
    private void uploadFile(Uri data){
        ...
        storageReference = firebaseStorage.getInstance().getReference();
        StorageReference ref = storageReference.child(ConstantsEL.STORAGE_PATH_UPLOADS + System.currentTimeMillis() + ".pdf");
