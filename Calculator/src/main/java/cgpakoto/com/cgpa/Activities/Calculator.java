...
public class Calculator extends AppCompatActivity implements ItemAdapter.OnCourseClickListener {
        ...
        if (semistr.equals("")){
          ...
          //  Toast.makeText(this, "Name" + semistr, Toast.LENGTH_SHORT).show();
            ...
            if (mycourse != null) {
             ...
             RecyclerInitialize();
            mydialog = new Dialog(Calculator.this);
    ...
    private void SaveButtonclick() {
      ...
      saveSemister.setOnClickListener(new View.OnClickListener() {
          ...
          public void onClick(View v) {
              ...
              if (name.equals("")){
                  Toast.makeText(Calculator.this, "Please Insert A Name to save", Toast.LENGTH_SHORT).show();
              }
              else {
                   Semister temp = new Semister(returnCgpa(),name,returntotalCredit());
                   myViewModel.insertSemister(temp);
                  Toast.makeText(Calculator.this, "Semiseter Saved", Toast.LENGTH_SHORT).show();
